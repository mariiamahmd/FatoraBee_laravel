  ...
  public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        $data['add_documents'] = $request->has(key: 'add_documents');
...
public function edit($id)
{
    ...
    return view('recurring_expenses.edit', compact('recurring_expense', 'clients'));
}
    ...
    public function update(Request $request, $id)
    {
       ...
       $data = $request->validate([
        ...
        $recurring_expense->update([
            ...
            'publicnotes' => $data['publicnotes'] ?? null,
            'privatenotes' => $data['privatenotes'] ?? null,
            'should_be_invoiced' => $data['should_be_invoiced'],
            'mark_paid' => $data['mark_paid'],
            'convert_currency' => $data['convert_currency'],
            'add_documents' => $data['add_documents'],
